...
use crate::agent::tools::branch::callbacks::{
...
impl ListBranchesTool {
    ...
    #[must_use]
    pub fn new(list_callback: BranchListCallback) -> Self {
        Self { list_callback }
    }
}
...
mod tests {
    use super::*;
    use crate::agent::tools::branch::callbacks::{BranchCreationResult, BranchId};
    use std::collections::HashMap;
    use std::sync::Arc;
