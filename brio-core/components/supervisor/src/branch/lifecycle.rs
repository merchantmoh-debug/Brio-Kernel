...
mod tests {
    ...
    struct MockBranchRepository {
        branches: Mutex<HashMap<BranchId, crate::domain::BranchRecord>>,
    }
    ...
    impl BranchRepository for MockBranchRepository {
        fn create_branch(
            &self,
            branch: &crate::domain::BranchRecord,
        ...
        fn get_branch(
            &self,
            id: BranchId,
        ) -> Result<Option<crate::domain::BranchRecord>, BranchRepositoryError> {
            let branches = self
                .branches
                .lock()
                .map_err(|_| BranchRepositoryError::SqlError("Lock failed".to_string()))?;
        ...
        fn list_active_branches(
            &self,
        ) -> Result<Vec<crate::domain::BranchRecord>, BranchRepositoryError> {
            let branches = self
                .branches
                .lock()
                .map_err(|_| BranchRepositoryError::SqlError("Lock failed".to_string()))?;
        ...
        fn delete_branch(&self, _id: BranchId) -> Result<(), BranchRepositoryError> {
            Ok(())
        }
        ...
        fn create_merge_request(
            ...
            _strategy: &str,
        ) -> Result<crate::merge::MergeId, BranchRepositoryError> {
            Ok(crate::merge::MergeId::new())
        }

        fn get_merge_request(
            &self,
            _merge_id: crate::merge::MergeId,
        ) -> Result<Option<crate::domain::MergeRequest>, BranchRepositoryError> {
            Ok(None)
        }

        fn update_merge_request(
            &self,
            _merge_request: &crate::domain::MergeRequest,
        ) -> Result<(), BranchRepositoryError> {
            Ok(())
        }
    ...
    fn create_test_branch(id: u64, parent_id: Option<u64>) -> crate::domain::BranchRecord {
        let parent = parent_id.map(|pid| BranchId::from_uuid(uuid::Uuid::from_u128(pid as u128)));
        crate::domain::BranchRecord::new(
